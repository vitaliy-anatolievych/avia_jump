...
class Assets {
  ...
  static late final Sprite btnLeft;
  static late final Sprite btnFire;
  static late final Sprite btnRight;
  ...
  static Future<void> load() async {
    ...
    btnLeft = atlas.findSpriteByName('btn_left')!;
    btnRight = atlas.findSpriteByName('btn_right')!;
    btnFire = atlas.findSpriteByName('btn_fire')!;
